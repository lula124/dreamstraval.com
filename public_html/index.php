...
<body data-rsssl=1 class="home home-page"> 
...
<head>
    ...
    <title>Dreams Travel in Sri Lanka | Holiday Tours</title>
    <!-- Add the favicon link -->
    <link rel="icon" type="image/x-icon" href="images/asd.png">
	...
	<div class="inner-wrap">
		<div class="column">
			<div id="mainLogo" class="logo-wrap">
				<a href="https://dreamstraval.com" title="Dreams Travel">
					<img width="120%" height="120%" class="logo" src="images/dt-removebg.png" class="img-responsive lazy mobile-optimized" alt="" title="" alt="Jetwing Travels">
				</a>
					...
					<div class="email">
						<a href<head>
                            ...
                            <noscript>
                                ...
                                <link rel="stylesheet" media="print" onload="this.onload=null;this.removeAttribute('media');" href="style3.css">
                                <noscript>
                        ...
                        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-26380969-1"></script>
    ...
    <div class="desktop-menu">
        <nav id="top-nav">
            <ul id="top-menu" class="sm sm-simple">
                <li id="menu-item-6932" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6 current_page_item menu-item-6932">
                    <a href="https://dreamstraval.com/" aria-current="page" style="font-size: 13px;">Home</a>

                </li>
                <li id="menu-item-6878" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-6878">
                    <a href="about_us.html" style="font-size: 13px;">About Us</a>
                </li>
                <li id="menu-item-8488" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-6878">
                    <a href="Packages.html" style="font-size: 13px;">Packages</a>
                    <ul class="sub-menu">
                        <li id="menu-item-7610" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7610">
                            <a href="3day.html" style="font-size: 12px;" >Three Day Packages</a>
                        </li>
                        <li id="menu-item-7779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7779">
                            <a href="4day.html" style="font-size: 12px;">Four Day Packages</a>
                        </li>
                        <li id="menu-item-7779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7779">
                            <a href="5day.html" style="font-size: 12px;">Five Day Packages</a>
                        </li>
                        <li id="menu-item-7779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7779">
                            <a href="9day.html" style="font-size: 12px;">Nine Day Packages</a>
                        </li>
                        <li id="menu-item-7779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7779">
                            <a href="15day.html" style="font-size: 12px;">Fifteen Day Packages</a>
                        </li>
                        <li id="menu-item-7779" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7779">
                            <a href="AYURVEDA.html" style="font-size: 12px;">AYURVEDA PACKAGE</a>
                        </li>
                    </ul>
                </li>
                <li id="menu-item-8513" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8513">
                    <a href="contact.html" style="font-size: 13px;">Contact Us</a>
                </li>
            </ul>
            <br>
            <style>
                /* CSS for changing text color to #1975d1 on hover */
                #top-menu a:hover {
                    color: #1975d1;
                }

                /* CSS for changing color of current page link to #1975d1 */
            ...
            <style>
                /* CSS for changing text color to blue on hover */
                #top-menu a:hover {
                    color: #0d74db;
                }
                #menuwrapper .menu-item a:hover {
    /* Change the color to your desired color */
    color: #0d74db ; /* For example, changing it to red */
    /* You can also add other styles like background-color, font-weight, etc. */
}
            </style>
...
<form action="/" method="get" class="searchform">
	...
	<div class="mobile-nav">
		<nav id="mobile-nav">
			<ul id="mobile-menu" class="sm sm-simple"><li id="menu-item-9393" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6 current_page_item menu-item-9393"><a href="https://dreamstraval.com/" aria-current="page">Home</a></li>
<li id="menu-item-6278" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6278"><a href="about_us.html">About Us</a></li>
<li id="menu-item-6282" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6282"><a href="Packages.html">Packages</a></li>
<li id="menu-item-6279" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6279"><a href="gallery.html">Gallery</a></li>
<li id="menu-item-6884" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6884"><a href="places.html">Places</a></li>
<li id="menu-item-6884" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6884"><a href="plan.html">Plan Your Trip</a></li>
<li id="menu-item-6884" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6884"><a href="contact.html">Contact Us</a></li>
</ul> 
		</nav>
	</div>
	<div class="desktop-toggle-nav">
		<nav id="desktop-toggle-nav">
			<ul id="desktop-toggle-menu" class="sm sm-simple">
<li id="menu-item-6580" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6580"><a href="https://dreamstraval.com/">Home</a></li>
<li id="menu-item-6872" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6872"><a href="about_us.html">About Us</a></li>
<li id="menu-item-6579" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6579"><a href="Packages.html">Packages</a></li>
<li id="menu-item-6875" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6875"><a href="gallery.html">Gallery</a></li>
<li id="menu-item-7961" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7961"><a href="places.html">Places</a></li>
<li id="menu-item-6884" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6884"><a href="plan.html">Plan Your Trip</a></li>
<li id="menu-item-9033" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9033"><a href="contact.html">Contact Us</a></li>
</ul> 
		</nav>
	</div>
        ...
        <div class="main-slider" id="main-slider-wrap-full-screen">
            <div id="mainSlider" class="owl-carousel" style="display: block;">
                ...
                <div class="item" data-item="0" data-index="1">
                                    ...
                                    <picture> 
                                        <source media="(max-width: 991px)" srcset="images/homeimg (1).jpg">   
                                        <source media="(max-width: 1199px)" srcset="images/homeimg (1).jpg">   
                                        <img loading="lazy" src="images/homeimg (1).webp" class="img-responsive" alt="<?php  ?>" title="">
                                    </picture> 
                                    <div class="main-caption-block">
                                        
                                  <div class="banner-caption">
    <div class="title" style="font-weight: bold; text-shadow: -1px -1px 0 #000, 2px -1px 0 #000, -1px 1px 0 #000, 2px 2px 0 #000; color: white;">Welcome To Sri Lanka</div>
    <div class="sub-title" style="font-weight: bold; text-shadow: -1px -1px 0 #000, 2px -1px 0 #000, -1px 1px 0 #000, 2px 2px 0 #000; color: white;">Your Home, Your Journey is Here</div>
</div>

                                    <div class="destination-block"><div class="text-wrapper"><div class="destination-title" style="font-size: 15px;"> Sri Lanka’s South Coast Beaches</div><div class="destination-description" style="font-size: 14px;">Sri Lanka’s southern coast boasts of many palm fringed beaches lining its pristine white sand shores.</div></div></div>	
                                    </div>
                                </div>            </div>
        </div> 
                    ...
                    <div class="inner-wrapper"> 
                        <div class="column">
                            <div class="img-wrapper">
                                <br><br><br>
                                <picture> 
                                    <source media="(max-width: 767px)" srcset="images/wel.png"> 
                                    <source media="(max-width: 1199px)" srcset="images/wel.png"> 
                                    <img src="images/wel.png" class="img-responsive lazy" alt="" title="">
                                </picture>
                            </div>
                        </div>
                        <div class="column">
                            <div class="title-wrapper">
                                        ...
                                        <span class="text">Welcome to Dreams Travels</span>
                                    </div>
                                                                <h1 class="h1 title">
                                    The Home of Sri Lankan Tourism</h1>
                            </div>
                                                            <div class="btn-wrapper">
                                    <a class="link" href="about_us.html" target="">
                                      <span class="text" style="color: blue;">Learn More About us</span>
                                        <span class="icon">
                            ...
                            <div class="list">
                                <ul>
                                            ...
                                            <span class="text" style="font-size: 14px;">Immerse yourself in its vibrant culture, explore historic sites, and embrace breathtaking landscapes.</span>
                                    </li>
                                                                        <li>
                                            <span class="icon"></span>
                                            <span class="text" style="font-size: 14px;">Sri Lanka, a tropical jewel, beckons with pristine beaches, lush tea plantations, ancient cultural wonders, and diverse wildlife. </span>
                                    </li>
                                                                    </ul>
                                                                     <a> <button class="float-btn"><img src="images/icons8-whatsapp.gif" style="width: 40px; height: 40px;">
</button> </a>
                            </div>
                            <div class="statistics">
                                            ...
                                            <div class="item-inner">
                                                <div class="img-wrapper">
                                                    <img loading="lazy"  src="https://jetwingtravels.com/wp-content/uploads/2023/11/Almost-40-Years-In-Business-80x80-1.png" class="img-responsive lazy" alt="" title="">
                                                </div>
                                                <div class="value">
                                                                                                    </div>
                                                                                                    <div class="title">
                                            ...
                                            <div class="item-inner">
                                                <div class="img-wrapper">
                                                    <img loading="lazy"  src="https://jetwingtravels.com/wp-content/uploads/2023/11/Hotels-Across-v1-80x80-1.png" class="img-responsive lazy" alt="" title="">
                                                </div>
                                                <div class="value">
                                                                                                    </div>
                                                                                                    <div class="title">
                                            ...
                                            <div class="item-inner">
                                                <div class="img-wrapper">
                                                    <img loading="lazy"  src="https://jetwingtravels.com/wp-content/uploads/2023/11/Specialist-Teams-v1-80x80-1.png" class="img-responsive lazy" alt="" title="">
                                                </div>
                                                <div class="value">
                                                                                                    </div>
                                                                                                    <div class="title">
                                            ...
                                            <div class="item-inner">
                                                <div class="img-wrapper">
                                                    <img loading="lazy"  src="https://jetwingtravels.com/wp-content/uploads/2023/11/Best-Guides-v1-80x80-1.png" class="img-responsive lazy" alt="" title="">
                                                </div>
                                                <div class="value">
                                                                                                    </div>
                                                                                                    <div class="title">
                                                        Our Own Auto Fleet                                                    </div>
                                                                                            </div>
                                        </div>
                                                                        <div class="item">
                                            <div class="item-inner">
                                                <div class="img-wrapper">
                                                    <img loading="lazy"  src="https://jetwingtravels.com/wp-content/uploads/2023/11/Sustainability-80x80-2.png" class="img-responsive lazy" alt="" title="">
                                                </div>
                                                <div class="value">
                                                                                                    </div>
                                                                                                    <div class="title">
                                                        
                                                         Our Own Fleet of Vehicles                                                    </div>
                                                                                            </div>
                                        </div>
                                                                        <div class="item">
            ...
            <div class="container">
                <div class="cont-row">
                    <div class="title-wrapper">
                                ...
                                <span class="text">You are free to explore people, places, and pleasures.</span>
                            </div>
                                                <h2 class="h2 title">Our Island</h2>
                        <h3 class="h3 title-2">Sri Lanka</h3>
                    </div>
                    
                    <div class="btn-wrapper">
                        <a class="link" href="Packages.html">
                    ...
                    <div class="map-wrapper">
                        <div class="img-wrapper">
                            <img src="images/map (1).png" alt="Home">
                                                                            <a href="pinnawala.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="0" style="top: 45%; left: 30%; ">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Pinnawala</span>
                                                </div>
                                                </a>
                                                                            <a href="kandy.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="0" style="top: 42%; left: 45%; ">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Kandy</span>
                                                </div>
                                                </a>                         <a href="sigiriya.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="0" style="top: 32%; left: 42%;  ">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Sigiriya</span>
                                                </div>
                                                </a>                        <a href="colombo.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="0" style="top: 52%; left: 14%; ">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Colombo</span>
                                                </div>
                                                </a>
                                                                            <a href="kandy.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="1" style="top: 42%; left: 45%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Kandy</span>
                                                </div>
                                                </a>
                                                                            <div class="location-name jetwing-locale-location right" data-id="1" style="top: 35%; left: 42%;display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Dambulla</span>
                                                </div>
                                                                             <a href="sigiriya.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="1" style="top: 32%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Sigiriya&nbsp;</span>
                                                </div>
                                                </a>
                                                                            <a href="anuradapura.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="1" style="top: 24%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Anuradhapure</span>
                                                </div>      
                                                </a>
                                                                            <a href="wilpathu.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="1" style="top: 25%; left: 30%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Wilpathu</span>
                                                </div>
                                                </a>
                                                                            <a href="pinnawala.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="1" style="top: 45%; left: 30%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Pinnawala</span>
                                                </div>
                                                </a>
                                                                            <a href="victoriya.html" >
                                                                <div class="location-name jetwing-locale-location left" data-id="1" style="top: 48%; left: 45%;">
                                                                    <img src="images/mapp.png" alt="Map pointer">
                                                                    <span style="color: blue;">Digana</span>
                                                                </div>
                                                            </a>
                                                                            <a href="arugambe.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="1" style="top: 52%; left: 85%;display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Arugambe</span>
                                                </div>
                                                </a>    
                                                                             <a href="pinnawala.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="2" style="top: 45%; left: 30%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Pinnawala</span>
                                                </div>
                                                                            </a>
                                                                            
                                                                            <div class="location-name jetwing-locale-location right" data-id="2" style="top: 35%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Dambulla</span>
                                                </div>     
                                                               <a href="sigiriya.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="2" style="top: 32%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Sigiriya</span>
                                                </div>
                                                </a>
                                                                         <a href="kandy.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="2" style="top:42%; left: 45%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Kandy</span>
                                                </div>
                                                </a>
                                                
                                                                            <div class="location-name jetwing-locale-location left" data-id="2" style="top: 56%; left: 47%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Nuwara Eliya</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="2" style="top: 65%; left: 82%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Yala</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="2" style="top: 85%; left: 36%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Galle</span>
                                                </div>
                                                
                                                                        <a href="colombo.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="2" style="top: 52%; left: 14%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Colombo</span>
                                                </div>
                                                </a>
                                                                           <a href="pinnawala.html" >
                                                                          <div class="location-name jetwing-locale-location left" data-id="3" style="top: 45%; left: 30%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span  style="color: blue;">Pinnawala</span>
                                                </div>
                                                </a>
                                                
                                                                            <div class="location-name jetwing-locale-location right" data-id="3" style="top: 35%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Dambulla</span>
                                                </div>
                                                
                                                                        <a href="sigiriya.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="3" style="top:32%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Sigiriya</span>
                                                </div>
                                                </a>
                                                                            <a href="kandy.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="3" style="top: 42%; left: 45%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span  style="color: blue;" >Kandy</span>
                                                </div>
                                                </a>
                                                                            <div class="location-name jetwing-locale-location left" data-id="3" style="top:56%; left: 47%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Nuwara Eliya</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="3" style="top: 82%; left: 28%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Benthota</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="3" style="top: 65%; left: 82%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Yala</span>
                                                </div>
                                                
                                                     <a href="colombo.html" >
                                                <div class="location-name jetwing-locale-location left" data-id="3" style="top: 52%; left: 14%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;"  >Colombo</span>
                                                </div>
                                                </a>
                                                                         <a href="pinnawala.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top:  45%; left: 30%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;" >Pinnawala</span>
                                                </div>
                                                </a>
                                                                             <a href="anuradapura.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top: 24%; left: 42%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Anuradhapure</span>
                                                </div>
                                                </a>
                                                
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top: 40%; left: 61%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Polonnaruwa</span>
                                                </div>
                                                                         <a href="sigiriya.html" >
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top: 32%; left: 42%;  display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Sigiriya</span>
                                                </div>
                                                </a>
                                                                     <a href="kandy.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top:  42%; left: 45%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Kandy</span>
                                                </div>
                                                </a>
                                                
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top: 56%; left: 47%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Nuwara Eliya</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top: 55%; left: 73%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Ella</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top:75%; left: 36%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Udawalawa</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top:  65%; left: 82%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Yala</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top:80%; left: 68%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Mirissa</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top: 66%; left: 46%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Sinharaje</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top: 85%; left: 36%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Galle</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="4" style="top: 83%; left: 32%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Hikkaduwa</span>
                                                </div>
                                                                 <a href="colombo.html" >
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top:  52%; left: 14%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span style="color: blue;">Colombo</span>
                                                </div>
                                                </a>
                                                                            <div class="location-name jetwing-locale-location right" data-id="4" style="top: 82%; left: 28%;  display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Bentota</span>
                                                </div>
                                                                           
                                                                            <div class="location-name jetwing-locale-location right" data-id="5" style="top: 65%; left: 20%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Colombo&nbsp;</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="5" style="top: 67%; left: 31%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Ingiriya&nbsp;</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="5" style="top: 9%; left: 25%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Jaffna&nbsp;</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="5" style="top: 57%; left: 46%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Kandy&nbsp;</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="5" style="top: 57%; left: 53%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Mahiyangana</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location left" data-id="5" style="top: 70%; left: 81%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Arugam&nbsp;Bay&nbsp;</span>
                                                </div>
                                                                            <div class="location-name jetwing-locale-location right" data-id="5" style="top: 72%; left: 80%; display: none;">
                                                    <img src="images/mapp.png" alt="Map pointer">
                                                    <span>Panama&nbsp;Tank&nbsp;</span>
                                                </div>
                                                    </div>
                                                    
                                                        <div class="hm-locale-carousel owl-carousel">
                                                            
                                                
                                                  <div class="item jetwing-locale-trigger" data-id="0">
    <a href="3day.html">
        <div class="locale-links" 
             onmouseover="this.querySelector('.label').style.color = 'blue'" 
             onmouseout="this.querySelector('.label').style.color = 'black'">
            <div class="img">
                <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-03.jpg" alt="Home">
            </div>
            <div class="desc">
                <div class="label" style="color: black;">Tour Packages 3 Days</div>
                <div class="btn-wrapper"></div> 
                                               ...
                                               <div class="item jetwing-locale-trigger" data-id="1">
    <a href="4day.html">
        <div class="locale-links" onmouseover="this.querySelector('.label').style.color = 'blue';" onmouseout="this.querySelector('.label').style.color = 'black';">
            <div class="img">
                <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-02.jpg" alt="Home">
            </div>
            <div class="desc">
                <div class="label" style="color:black;">Tour Package 4 Days</div>
                <div class="btn-wrapper"></div>
            </div>
        </div>
    </a>
                                            ...
                                            <div class="item jetwing-locale-trigger" data-id="2">
                                                <a href="5day.html">
                                                <div class="locale-links" onmouseover="this.querySelector('.label').style.color = 'blue';" onmouseout="this.querySelector('.label').style.color = 'black';">
                                                    <div class="img">
                                                        <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-01.jpg" alt="Home">
                                                    </div>
                                                    <div class="desc">
                                                        <div class="label"  style="color:black;" >Tour Package 5 Days
</div>
                                                        <div class="btn-wrapper">
                                                                                                                    </div> 
                                                    </div>
                                            ...
                                            <div class="item jetwing-locale-trigger" data-id="3">
                                                 <a href="9day.html">
                                                <div class="locale-links" onmouseover="this.querySelector('.label').style.color = 'blue';" onmouseout="this.querySelector('.label').style.color = 'black';">
                                                    <div class="img">
                                                        <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-05.jpg" alt="Home">
                                                    </div>
                                                    <div class="desc">
                                                        <div class="label"  style="color:black;">Tour Package 9 Days</div>
                                                        <div class="btn-wrapper"></div> 
                                                    </div>
                                                </div>
                                                </a>
                                                                                ...
                                                                                <div class="item jetwing-locale-trigger" data-id="4">
                                                                                    <a href="15day.html">
                                                <div class="locale-links" onmouseover="this.querySelector('.label').style.color = 'blue';" onmouseout="this.querySelector('.label').style.color = 'black';">
                                                    <div class="img">
                                                        <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-04.jpg" alt="Home">
                                                    </div>
                                                    <div class="desc">
                                                        <div class="label" style="color:black;">Tour Packages 15 Days
</div>
                                                        <div class="btn-wrapper">
                                                                                                                    </div> 
                                                    </div>
                                            ...
                                            <div class="item jetwing-locale-trigger" data-id="5">
                                                <a href="AYURVEDA.html">
                                                <div class="locale-links" onmouseover="this.querySelector('.label').style.color = 'blue';" onmouseout="this.querySelector('.label').style.color = 'black';">
                                                    <div class="img">
                                                        <img src="https://jetwingtravels.com/wp-content/uploads/2023/11/expt-06.jpg" alt="Home">
                                                    </div>
                                                    <div class="desc">
                                                        <div class="label" style="color:black;">Ayurveda Package 21 Days</div>
                                                        <div class="btn-wrapper"></div> 
                                                    </div>
                                                </div>
                                                </a>
                    ...
                    <div class="inner-wrapper">
                        <div class="intro-wrapper">
                            <div class="title-wrapper">
                                        ...
                                        <span class="text">A land with unique locations</span>
                                    </div>
                                                                <h2 class="h2 title">
                                    Temples, woodlands, fortifications, and treasures                                </h2>
                                <h3 class="h3 title-2">
                                    Enchanting Locations                                </h3>
                            </div>
                                                            <div class="btn-wrapper">
                                    <a class="link" href="Packages.html" target="">
                                        <span class="text" style="color: blue;">
                                            View Packages                                        </span>
                                        <span class="icon">
                        ...
                        <div class="destinations-wrapper">
                                                        <div class="column">
                                <div class="item">
                                    <a href="pinnawala.html" target="">
                                        <div class="img-wrapper">
                                            <img src="images/young-elephants-264711_1280.jpg" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                                            <div class="title">Pinnawala Elephant Orphanage</div>
                                                                                            <div class="location">
                                                    <span class="icon">
                                ...
                                <div class="item">
                                    <a href="kandy.html" target="">
                                        <div class="img-wrapper">
                                            <img src="images/sri-lanka-2107620_1280.jpg" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                                ...
                                <div class="item">
                                    <a href="sigiriya.html" target="">
                                        <div class="img-wrapper">
                                            <img src="images/sigiriya-2516894_1280.jpg" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                            ...
                            <div class="column">
                                <div class="item">
                                    <a href="colombo.html" target="">
                                        <div class="img-wrapper">
                                            <img src="https://jetwingtravels.com/wp-content/uploads/2023/08/Untitled-1.jpg" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                                ...
                                <div class="item">
                                    <a href="anuradapura.html" target="">
                                        <div class="img-wrapper">
                                            <img src="images/stupa-3985290_1280.jpg" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                                ...
                                <div class="item">
                                    <a href="wilpathu.html" target="">
                                        <div class="img-wrapper">
                                            <img src="images/vilpathu.webp" class="img-responsive lazy mobile-optimized" alt="" title=""> 
                                        </div>
                                        <div class="content-wrapper">
                                            <div class="title">WILPATTU</div>
                                                                                            <div class="location">
                                                    <span class="icon">
...
<footer class="instagram-enabled" style="background: #092e96;"> 
			...
			<div class="row">
				<div class="inner-wrapper">
					<div class="title-wrapper">
						...
						<div class="insta-id">
							<a target="_blank" href="jetwingtravels">Dreams Travel</a>
						</div>
					</div>
					<div class="carousel-wrapper">
						<div class="owl-carousel instagram-carousel">
										...
										<div class="ins-img">
											<img src="images/5bd32e23c9543-wallpaper-preview.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/100v1f000001h1dja8A9D-scaled.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/pexels-asad-photo-maldives-1450353.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/eagle-7098711_1280.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/elephant-2314239_1280.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/busy-street-4534538_1280.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/sigiriya-2516894_1280.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/sri-lanka-2107620_1280.jpg">
										</div>
										...
										<div class="ins-img">
											<img src="images/sri-lanka-5061995_1280.jpg">
										</div>
			...
			<div class="row">
				<div class="inner-wrapper">
					<div class="row-1">
							...
							<div class="title-wrapper">
								<div class="title" style="font-size: 43px;">
									AMILA HOLDING							</div>
								<div class="sub-title" style="font-size: 13px;">
									For the latest updates and special offers. 								</div>
							</div>
							<div class="form-wrapper">
								
<div class="wpcf7 no-js" id="wpcf7-f1158-o2" lang="en-US" dir="ltr">
<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
<form action="/#wpcf7-f1158-o2" method="post" class="wpcf7-form init mailchimp-ext-0.5.72" aria-label="Contact form" novalidate="novalidate" data-status="init">
						...
						<div class="column">
							<div class="block footer-navigation">
								...
								<div class="footer-menu-wrapper">
									<ul id="footer-menu-1" class="footer-menu"><li id="menu-item-6285" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6 current_page_item menu-item-6285"><a href="https://dreamstraval.com/" aria-current="page">Home</a></li>
<li id="menu-item-6286" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6286"><a href="about_us.html">About Us</a></li>
<li id="menu-item-6887" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6887"><a href="Packages.html">Packages</a></li>
<li id="menu-item-8910" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8910"><a href="places.html">places</a></li>
<li id="menu-item-6288" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6288"><a href="contact.html">Contact Us</a></li>
</ul>								</div>
							</div>
							<div class="block footer-navigation">
								<div class="f-title">
								...
								<div class="footer-menu-wrapper">
									<ul id="quick-links" class="footer-menu"><li id="menu-item-7963" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7963"><a href=""></a></li>
<li id="menu-item-7962" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7962"><a href=""></a></li>
<li id="menu-item-8234" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-8234"><a href=""></a></li>
<li id="menu-item-8909" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8909"><a href=""></a></li>
</ul>								</div>
							</div>
						</div>
						<div class="column">
							<div class="block footer-navigation">
								<div class="f-title">
									Our Packages								</div>
								<div class="footer-menu-wrapper">
									<ul id="footer-menu-2" class="footer-menu"><li id="menu-item-5640" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5640"><a href="https://www.dreamstraval.com/">Dreams Travel</a></li>
<li id="menu-item-5641" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5641"><a href="3day.html">Three Days</a></li>
<li id="menu-item-5642" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5642"><a href="4day.html">Four Days</a></li>
<li id="menu-item-5643" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5643"><a href="5day.html">Five Days</a></li>
<li id="menu-item-5644" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5644"><a href="9day.html">Nine Days</a></li>
<li id="menu-item-5645" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5645"><a href="15day.html">Fifteen Days</a></li>
<li id="menu-item-7937" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-7937"><a href="AYURVEDA.html">Ayurveda Package</a></li>
</ul>								</div>
							</div>
						</div>
						<div class="column">
...
<li id="menu-item-8901" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8901"><a href="">Pinnawala Elephant Orphanage</a></li>
<li id="menu-item-8902" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8902"><a href="">Sri Dalada Maligawa, Kandy</a></li>
<li id="menu-item-8903" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8903"><a href="">Sigiriya</a></li>
<li id="menu-item-8904" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8904"><a href="">Colombo</a></li>
<li id="menu-item-8905" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8905"><a href="">Anuradhapura</a></li>
<li id="menu-item-8906" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8906"><a href="">WILPATTU</a></li>
<li id="menu-item-8907" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8907"><a href="">Victoria Gold Resort – Digana</a></li>
<li id="menu-item-8908" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8908"><a href="">Arugam Bay</a></li>
</ul>												</div>
							</div>
						</div>
						<div class="column">
							<div class="block contact-details">
								...
								<div class="hotline"> 
									<span class="icon">
    <svg class="svg-phone"  style="fill: lightblue; outline:lightblue;">
        <use xlink:href="#svg-phone"></use>
    </svg> 
</span>
									<span class="content">
																					<a href="tel:+94752364570">0752364570</a>
																			</span> 
								</div>
								<div class="availability">
									<b></b> 								</div>
																	<div class="footer-address">
											<b>Dreams Travels</b><br>Itthapana<br>Mathugama,<br>SRI LANKA.									</div>
								...
								<div class="email-addresses">
									<div class="title">E-mail:</div>
																			<a href="bluemountain@gmail.com"><span class="__cf_email__" data-cfemail="96fff8e7e3ffe4fff3e5d6fcf3e2e1fff8f1e2e4f7e0f3fae5b8f5f9fb">bluemountain@gmail.com</span></a>
																	</div>
							</div>
					...
					<div class="row-3">
							...
							<div class="social-media-icons">
								<ul>
										...
										<a href="" target="_blank">
											<svg class="icon svg-facebook" style="fill: lightblue;">
									...
									<li>
										<a href="" target="_blank">
											<svg class="icon svg-youtube" style="fill: lightblue;">
												<use xlink:href="#svg-icon-youtube"></use>
																		...
																		<li>
										<a href="" target="_blank">
											<svg class="icon svg-instagram" style="fill: lightblue;">
												<use xlink:href="#svg-icon-instagram"></use>
											</svg>
										</a>
									</li>
																		<li>
										<a href="" target="_blank">
											<svg class="icon svg-tiktok" style="fill: lightblue;">
						...
						<div class="footer-logo">
							<a href="https://dreamstraval.com" title="Jetwing Travels">
								<img width="100%" height="100%" class="logo" style="background: #c6d3f4;" src="images/dt-removebg.png" class="img-responsive lazy mobile-optimized" alt="" title="" alt="Jetwing Travels">
							</a>
						</div>
					</div>
				</div>
				...
				<div class="inner-wrapper" > 
					<div class="column-wrapper">
							<div class="column">
								...
								&#169; 2024 Dreams Travel,&nbsp; All Rights Reserved
								</div> 
							</div> 
							<div class="column">	
								<div class="site-by">
    Developed by <a href="">MLG Dissanayeka</a>&nbsp;&nbsp;&nbsp;&nbsp;Design & Photography by <a href="">M Jayasinghe</a>
</div>
...
<div class="wpcf7 no-js" id="wpcf7-f9105-o3" lang="en-US" dir="ltr">
<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
<form action="/#wpcf7-f9105-o3" method="post" class="wpcf7-form init mailchimp-ext-0.5.72" aria-label="Contact form" novalidate="novalidate" data-status="init">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="9105" />
<input type="hidden" name="_wpcf7_version" value="5.8.7" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f9105-o3" />
<input type="hidden" name="_wpcf7_container_post" value="0" />
<input type="hidden" name="_wpcf7_posted_data_hash" value="" />
<input type="hidden" name="_wpcf7_recaptcha_response" value="" />
</div>
<div class="input-group-wrapper">
   <div class="input-group half-width-sm full-width-xs"><label>Your Name*:</label><span class="wpcf7-form-control-wrap" data-name="Jname"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-element" aria-required="true" aria-invalid="false" value="" type="text" name="Jname" /></span></div>
<div class="input-group half-width-sm full-width-xs"><label>Your Email*:</label><span class="wpcf7-form-control-wrap" data-name="Jemail"><input size="40" class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email form-element" aria-required="true" aria-invalid="false" value="" type="email" name="Jemail" /></span></div>
<div class="input-group half-width-sm full-width-xs"><label>Phone*:</label><span class="wpcf7-form-control-wrap" data-name="Jphonetext"><input size="40" class="wpcf7-form-control wpcf7-phonetext wpcf7-text wpcf7-validates-as-phonetext form-element" aria-invalid="false" placeholder="Phone*:" value="" type="text" name="Jphonetext" /><input type="hidden" name="Jphonetext-country-code" class="wpcf7-phonetext-country-code" /></span></div>
<div class="input-group half-width-sm full-width-xs">
<label>Country*:</label>
<span class="wpcf7-form-control-wrap" data-name="country-code"><select class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false" name="country-code"><option value="">&#8212;Please choose an option&#8212;</option><option value="Algeria">Algeria</option><option value="Andorra">Andorra</option><option value="Angola Anguilla">Angola Anguilla</option><option value="Antigua &amp; Barbuda">Antigua &amp; Barbuda</option><option value="Argentina">Argentina</option><option value="Armenia">Armenia</option><option value="Aruba">Aruba</option><option value="Australia">Australia</option><option value="Austria">Austria</option><option value="Azerbaijan">Azerbaijan</option><option value="Bahamas">Bahamas</option><option value="Bahrain">Bahrain</option><option value="Bangladesh">Bangladesh</option><option value="Barbados">Barbados</option><option value="Belarus">Belarus</option><option value="Belgium">Belgium</option><option value="Belize">Belize</option><option value="Benin">Benin</option><option value="Bermuda">Bermuda</option><option value="Bhutan">Bhutan</option><option value="Bolivia">Bolivia</option><option value="Bosnia Herzegovina">Bosnia Herzegovina</option><option value="Botswana">Botswana</option><option value="Brazil">Brazil</option><option value="Brunei">Brunei</option><option value="Bulgaria">Bulgaria</option><option value="Burkina Faso">Burkina Faso</option><option value="Burundi">Burundi</option><option value="Cambodia">Cambodia</option><option value="Cameroon">Cameroon</option><option value="Canada Cape Verde Islands">Canada Cape Verde Islands</option><option value="Cayman Islands">Cayman Islands</option><option value="Central African Republic">Central African Republic</option><option value="Chile">Chile</option><option value="China">China</option><option value="Colombia">Colombia</option><option value="Comoros">Comoros</option><option value="Congo">Congo</option><option value="Cook Islands">Cook Islands</option><option value="Costa Rica">Costa Rica</option><option value="Croatia">Croatia</option><option value="Cuba">Cuba</option><option value="Cyprus North">Cyprus North</option><option value="Cyprus South">Cyprus South</option><option value="Czech Republic">Czech Republic</option><option value="Denmark">Denmark</option><option value="Djibouti">Djibouti</option><option value="Dominica Dominican Republic">Dominica Dominican Republic</option><option value="Ecuador Egypt">Ecuador Egypt</option><option value="El Salvador">El Salvador</option><option value="Equatorial Guinea">Equatorial Guinea</option><option value="Eritrea">Eritrea</option><option value="Estonia">Estonia</option><option value="Ethiopia">Ethiopia</option><option value="Falkland Islands">Falkland Islands</option><option value="Faroe Islands">Faroe Islands</option><option value="Fiji">Fiji</option><option value="Finland France">Finland France</option><option value="French Guiana">French Guiana</option><option value="French Polynesia">French Polynesia</option><option value="Gabon">Gabon</option><option value="Gambia">Gambia</option><option value="Georgia">Georgia</option><option value="Germany">Germany</option><option value="Ghana">Ghana</option><option value="Gibraltar">Gibraltar</option><option value="Greece">Greece</option><option value="Greenland">Greenland</option><option value="Grenada">Grenada</option><option value="Guadeloupe">Guadeloupe</option><option value="Guam">Guam</option><option value="Guatemala">Guatemala</option><option value="Guinea">Guinea</option><option value="Guinea - Bissau">Guinea - Bissau</option><option value="Guyana">Guyana</option><option value="Haiti">Haiti</option><option value="Honduras">Honduras</option><option value="Hong Kong">Hong Kong</option><option value="Hungary">Hungary</option><option value="Iceland">Iceland</option><option value="India">India</option><option value="Indonesia">Indonesia</option><option value="Iran">Iran</option><option value="Iraq">Iraq</option><option value="Ireland">Ireland</option><option value="Israel">Israel</option><option value="Italy">Italy</option><option value="Jamaica">Jamaica</option><option value="Japan">Japan</option><option value="Jordan">Jordan</option><option value="Kazakhstan">Kazakhstan</option><option value="Kenya">Kenya</option><option value="Kiribati">Kiribati</option><option value="Korea North">Korea North</option><option value="Korea South">Korea South</option><option value="Kuwait">Kuwait</option><option value="Kyrgyzstan">Kyrgyzstan</option><option value="Laos">Laos</option><option value="Latvia">Latvia</option><option value="Lebanon">Lebanon</option><option value="Lesotho">Lesotho</option><option value="Liberia">Liberia</option><option value="Libya">Libya</option><option value="Liechtenstein">Liechtenstein</option><option value="Lithuania">Lithuania</option><option value="Luxembourg">Luxembourg</option><option value="Macao">Macao</option><option value="Macedonia">Macedonia</option><option value="Madagascar">Madagascar</option><option value="Malawi">Malawi</option><option value="Malaysia">Malaysia</option><option value="Maldives">Maldives</option><option value="Mali">Mali</option><option value="Malta">Malta</option><option value="Marshall Islands">Marshall Islands</option><option value="Martinique">Martinique</option><option value="Mauritania">Mauritania</option><option value="Mayotte">Mayotte</option><option value="Mexico">Mexico</option><option value="Micronesia">Micronesia</option><option value="Moldova">Moldova</option><option value="Monaco">Monaco</option><option value="Mongolia">Mongolia</option><option value="Montserrat">Montserrat</option><option value="Morocco">Morocco</option><option value="Mozambique">Mozambique</option><option value="Myanmar">Myanmar</option><option value="Namibia">Namibia</option><option value="Nauru">Nauru</option><option value="Nepal">Nepal</option><option value="Netherlands">Netherlands</option><option value="New Caledonia">New Caledonia</option><option value="New Zealand">New Zealand</option><option value="Nicaragua">Nicaragua</option><option value="Niger">Niger</option><option value="Nigeria">Nigeria</option><option value="Niue">Niue</option><option value="Norfolk Islands">Norfolk Islands</option><option value="Northern Marianas">Northern Marianas</option><option value="Norway">Norway</option><option value="Oman">Oman</option><option value="Palau">Palau</option><option value="Panama">Panama</option><option value="Papua New Guinea">Papua New Guinea</option><option value="Paraguay">Paraguay</option><option value="Peru">Peru</option><option value="Philippines">Philippines</option><option value="Poland">Poland</option><option value="Portugal">Portugal</option><option value="Puerto Rico">Puerto Rico</option><option value="Qatar">Qatar</option><option value="Reunion">Reunion</option><option value="Romania">Romania</option><option value="Russia">Russia</option><option value="Rwanda">Rwanda</option><option value="San Marino">San Marino</option><option value="Sao Tome &amp; Principe">Sao Tome &amp; Principe</option><option value="Saudi Arabia">Saudi Arabia</option><option value="Senegal">Senegal</option><option value="Serbia">Serbia</option><option value="Seychelles">Seychelles</option><option value="Sierra Leone">Sierra Leone</option><option value="Singapore">Singapore</option><option value="Slovak Republic">Slovak Republic</option><option value="Slovenia">Slovenia</option><option value="Solomon Islands">Solomon Islands</option><option value="Somalia">Somalia</option><option value="South Africa">South Africa</option><option value="Spain">Spain</option><option value="Sri Lanka">Sri Lanka</option><option value="St. Helena">St. Helena</option><option value="St. Kitts">St. Kitts</option><option value="St. Lucia">St. Lucia</option><option value="Sudan">Sudan</option><option value="Suriname">Suriname</option><option value="Swaziland">Swaziland</option><option value="Sweden">Sweden</option><option value="Switzerland">Switzerland</option><option value="Syria">Syria</option><option value="Taiwan">Taiwan</option><option value="Tajikstan">Tajikstan</option><option value="Thailand">Thailand</option><option value="Togo">Togo</option><option value="Tonga">Tonga</option><option value="Trinidad &amp; Tobago">Trinidad &amp; Tobago</option><option value="Tunisia">Tunisia</option><option value="Turkey">Turkey</option><option value="Turkmenistan">Turkmenistan</option><option value="Turkmenistan">Turkmenistan</option><option value="Turks &amp; Caicos Islands">Turks &amp; Caicos Islands</option><option value="Tuvalu">Tuvalu</option><option value="Uganda">Uganda</option><option value="UK">UK</option><option value="Ukraine">Ukraine</option><option value="United Arab Emirates">United Arab Emirates</option><option value="Uruguay">Uruguay</option><option value="USA">USA</option><option value="Uzbekistan">Uzbekistan</option><option value="Vanuatu">Vanuatu</option><option value="Vatican City">Vatican City</option><option value="Venezuela">Venezuela</option><option value="Vietnam">Vietnam</option><option value="Virgin Islands - British">Virgin Islands - British</option><option value="Virgin Islands - US">Virgin Islands - US</option><option value="Wallis &amp; Futuna">Wallis &amp; Futuna</option><option value="Yemen (North)">Yemen (North)</option><option value="Yemen (South)">Yemen (South)</option><option value="Zambia">Zambia</option><option value="Zimbabwe">Zimbabwe</option></select></span>
</div>
<div class="input-group half-width-sm full-width-xs"><label>Date*:</label><span class="wpcf7-form-control-wrap" data-name="Jdate"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-element video-chat-date" aria-required="true" aria-invalid="false" value="" type="text" name="Jdate" /></span></div>
<div class="input-group half-width-sm full-width-xs"><label>Your Time*:</label><span class="wpcf7-form-control-wrap" data-name="jtime"><select class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required form-element video-chat-time" aria-required="true" aria-invalid="false" name="jtime"><option value="">&#8212;Please choose an option&#8212;</option></select></span></div>
<div class="input-group full-width-xs"><label>Message:</label><span class="wpcf7-form-control-wrap" data-name="Jmessage"><textarea cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-element" aria-invalid="false" name="Jmessage"></textarea></span></div> 
  <div class="input-group full-width-xs btn-wrapper"><button id="submit" class="wpcf7-form-control wpcf7-submit btn-submit" type="submit"><span class="text">Submit</span><span class="icon"> <svg class="svg-chevron-right"><use xlink:href="#svg-chevron-right"></use> </svg> </span></button></div></div><div class="wpcf7-response-output" aria-hidden="true"></div><p style="display: none !important"><span class="wpcf7-form-control-wrap referer-page"><input type="hidden" name="referer-page" value="http://Direct%20Visit" data-value="http://Direct%20Visit" class="wpcf7-form-control wpcf7-text referer-page" aria-invalid="false"></span></p>
<!-- Chimpmatic extension by Renzo Johnson -->
</form>
</div>
	</div>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
	...
	<symbol id="svg-blog" viewBox="0 0 32 38">
		<image id="blog.svg" width="32" height="38" xlink:href="data:img/png;base64,"/>
	</symbol>
	...
	<symbol id="svg-green-arrow-right" viewBox="0 0 16 16">
		<image id="green-arrow-right.svg" width="16" height="16" xlink:href="data:img/png;base64,"/>
	</symbol> 
	...
	<symbol id="svg-dash-line" viewBox="0 0 144 2">
		<image id="dash.svg" width="144" height="2" xlink:href="data:img/png;base64,iVBORw0KGgoAAAANSUhEUgAAAJAAAAACCAYAAAC36FXwAAAATklEQVQ4jWNccaL+PwPxQJCBgeEDkappZS5IHT+RahUZGBge0MBcQwYGhgtEqgXZL08Dc0Hq9IlU68jAwHCABuYGMhGpcBSMAkzAwMAAAF7ZD0NwALsrAAAAAElFTkSuQmCC"/>
	</symbol> 
...
/* <![CDATA[ */
var wpcf7_recaptcha = {"sitekey":"6LcZ41QpAAAAACf5hOgdquyXyvYxF0hMPfvaIq8B","actions":{"homepage":"homepage","contactform":"contactform"}};
/* ]]> */
</script>
...
<script defer src="java3.js"></script>
<script>
